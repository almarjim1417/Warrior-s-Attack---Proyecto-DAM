...
public class CameraFollow : MonoBehaviour
{
    ...
    // Usamos LateUpdate para que la cámara se mueva después del jugador
    void LateUpdate()
    {
        if (target != null)
        {
            // Calculamos la posición X + la diferencia con el centro
            ...
            if (useFixedY)
            {
                targetY = fixedYPosition; // Altura fija
            }
            else
            {
            ...
            // Mover la cámara suavemente hacia el lugar deseado
